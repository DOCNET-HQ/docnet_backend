...
class Appointment(models.Model):
    ...
    meeting_link = models.URLField(
        ...
        verbose_name=_('Meeting Link/Room ID'),
        help_text=_('Video conference URL or room identifier')
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.meeting_link and self.status in [
            AppointmentStatus.SCHEDULED,
            AppointmentStatus.CONFIRMED
        ]:
            self.meeting_link = f"https://meet.example.com/{self.id}"
