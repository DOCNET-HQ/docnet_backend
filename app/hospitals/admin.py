...
class HospitalAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        ...
        'registration_number', 'city', 'state', 'postal_code',
    ]
    readonly_fields = ['id', 'created_at', 'updated_at']
    list_filter = [
        'is_active', 'kyc_status', 'license_expiry_date',
    ]
    ordering = ('-created_at',)
    fieldsets = (
        (
...
class HospitalKYCRecordAdmin(admin.ModelAdmin):
    list_display = [
        'hospital', 'status', 'reviewed_by', 'reviewed_at'
    ]
    search_fields = [
        'hospital__name', 'hospital__user__email', 'status',
